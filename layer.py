...
class Layer:
    ...
    def __init__(self, in_features, out_features, activation_function=activation_func.Logistic, dropout_prob=None, batch_norm_1d_size=None):
        """
    ...
    def train_forward(self, input_links):
        ...
        self.output = self.activation_function.fn(self.input)
        return self.output
    ...
    def forward(self, input_links):
        ...
        return self.activation_function.fn(input_links @ self.weights)
    ...
    def calculate_output_delta(self, true_output):
        ...
        self.delta = np.multiply(self.activation_function.drv(self.input), error)
    ...
    def calculate_delta(self, last_layer_delta):
        ...
        Returns:
            Delta value for the previous layer.
        """
        self.delta = np.multiply(self.activation_function.drv(self.input), last_layer_delta)
        return self.calculate_delta_with_weights()
